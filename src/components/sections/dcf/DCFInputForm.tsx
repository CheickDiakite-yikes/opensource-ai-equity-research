      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input 
            ...
            value={parseFloat(customParams.longTermGrowthRate) * 100} 
            onChange={onInputChange}
            type="number"
            step="0.1"
            placeholder="4"
        ...
        <div className="space-y-2">
          ...
          <Input 
            name="riskFreeRate" 
            value={parseFloat(customParams.riskFreeRate) * 100} 
            onChange={onInputChange}
            type="number"
            step="0.1"
            placeholder="3.64"
        ...
        <div className="space-y-2">
          ...
          <Input 
            ...
            value={parseFloat(customParams.marketRiskPremium) * 100} 
            onChange={onInputChange}
            type="number"
            step="0.1"
            placeholder="4.72"
        ...
        <div className="space-y-2">
          ...
          <Input 
            name="costOfDebt" 
            value={parseFloat(customParams.costOfDebt) * 100} 
            onChange={onInputChange}
            type="number"
            step="0.1"
            placeholder="3.64"
