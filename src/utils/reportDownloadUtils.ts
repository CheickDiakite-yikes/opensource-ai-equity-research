...
export const downloadReportAsHTML = (report: ResearchReport) => {
  ...
  content += `
    <div class="disclaimer">
      <h2>Disclaimer</h2>
      <p>This report is generated using AI and should not be the sole basis for investment decisions. Always conduct your own research and consult with a financial advisor.</p>
    </div>`;
